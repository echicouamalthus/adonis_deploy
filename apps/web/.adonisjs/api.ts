...
type HealthGetHead = {
  request: unknown
  response: MakeTuyauResponse<import('../app/core/controllers/health_controller.ts').default['handle'], false>
}
type ApiHelloGetHead = {
  request: unknown
  response: MakeTuyauResponse<import('../app/marketing/controllers/hello_controller.ts').default['handle'], false>
}
type ApiVisiontestPost = {
  request: unknown
  response: MakeTuyauResponse<import('../app/marketing/controllers/vision_test_controller.ts').default['handle'], false>
}
type LoginGetHead = {
  request: unknown
...
type ApiScansGetHead = {
  request: unknown
  response: MakeTuyauResponse<import('../app/scans/controllers/api/scans_controller.ts').default['index'], false>
}
type ApiScansIdGetHead = {
  request: unknown
  response: MakeTuyauResponse<import('../app/scans/controllers/api/scans_controller.ts').default['show'], false>
}
type ApiCreditsGetHead = {
  request: unknown
  response: MakeTuyauResponse<import('../app/credits/controller/api/credit_controller.ts').default['show'], false>
}
type ApiCreditsHistoryGetHead = {
  request: unknown
  response: MakeTuyauResponse<import('../app/credits/controller/api/credit_controller.ts').default['history'], false>
}
type ApiSharesPost = {
  request: MakeTuyauRequest<InferInput<typeof import('../app/shares/validators.ts')['createShareValidator']>>
  response: MakeTuyauResponse<import('../app/shares/controller/api/share_controller.ts').default['store'], true>
}
type ApiSharesStatsGetHead = {
  request: unknown
  response: MakeTuyauResponse<import('../app/shares/controller/api/share_controller.ts').default['stats'], false>
}
type UsersGetHead = {
  request: MakeTuyauRequest<InferInput<typeof import('../app/users/validators.ts')['listUserValidator']>>
  response: MakeTuyauResponse<import('../app/users/controllers/users_controller.ts').default['index'], true>
}
type UsersPost = {
...
export interface ApiDefinition {
  ...
  'api': {
    'hello': {
      ...
      '$get': ApiHelloGetHead;
      '$head': ApiHelloGetHead;
    };
    'vision-test': {
      '$url': {
      };
      '$post': ApiVisiontestPost;
    };
    'scans': {
      '$url': {
      };
      '$post': ApiScansPost;
      '$get': ApiScansGetHead;
      '$head': ApiScansGetHead;
      ':id': {
        '$url': {
        };
        '$get': ApiScansIdGetHead;
        '$head': ApiScansIdGetHead;
      };
    };
    'credits': {
      '$url': {
      ...
      '$head': ApiCreditsGetHead;
      'history': {
        '$url': {
        };
        '$get': ApiCreditsHistoryGetHead;
        '$head': ApiCreditsHistoryGetHead;
      };
    };
    'shares': {
      '$url': {
      ...
      'stats': {
        ...
        '$get': ApiSharesStatsGetHead;
        '$head': ApiSharesStatsGetHead;
      };
    };
    'tokens': {
      '$url': {
...
const routes = [
  ...
  },
  {
    ...
    path: '/api/hello',
    method: ["GET","HEAD"],
    types: {} as ApiHelloGetHead,
  },
  {
    params: [],
    name: 'api.vision-test',
    path: '/api/vision-test',
    method: ["POST"],
    types: {} as ApiVisiontestPost,
  },
  {
    params: [],
  ...
  },
  {
    ...
    method: ["GET","HEAD"],
    types: {} as ApiCreditsHistoryGetHead,
  },
  {
    params: [],
    name: 'shares.store',
    path: '/api/shares',
    method: ["POST"],
    types: {} as ApiSharesPost,
  },
  {
    params: [],
    name: 'shares.stats',
    path: '/api/shares/stats',
    method: ["GET","HEAD"],
    types: {} as ApiSharesStatsGetHead,
  },
  {
    params: [],
    name: 'users.index',
