...
type HealthGetHead = {
  ...
  response: MakeTuyauResponse<
    import('../app/core/controllers/health_controller.ts').default['handle'],
    false
  >
}
type ApiHelloGetHead = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/marketing/controllers/hello_controller.ts').default['handle'],
    false
  >
}
type LoginGetHead = {
...
type UsersGetHead = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('../app/users/validators.ts'))['listUserValidator']>
  >
  response: MakeTuyauResponse<
